...
Shader "SpecialLights/PointArea" {
	SubShader{
...
#include "UnityDeferredLibrary.cginc"
	...
	// z 1/radius
	// w kind
	float4 _SpecialLightParams;
#define _SpecialLightLength _SpecialLightParams.x
#define _SpecialLightSize _SpecialLightParams.y
#define _SpecialLightInvSqRadius _SpecialLightParams.z
#define _SpecialLightKind _SpecialLightParams.w
		...
		out float outFadeDist)
	{
		...
		float att = dot(tolight, tolight) * _SpecialLightInvSqRadius;
	...
	half4 CalculateLight(unity_v2f_deferred i)
	{
		...
		if (_SpecialLightKind == 1)
		{
			float3 lightPos1 = lightPos + lightAxisX * _SpecialLightLength;
			float3 lightPos2 = lightPos - lightAxisX * _SpecialLightLength;
			light.dir = CalcTubeLightToLight(wpos, lightPos1, lightPos2, eyeVec, normalWorld, _SpecialLightSize);
		}
		else
		{
			light.dir = CalcSphereLightToLight(wpos, lightPos, eyeVec, normalWorld, _SpecialLightSize);
		}
...
#pragma exclude_renderers nomrt
	...
	{
		return half4(_SpecialLightColor.rgb, 1);
	}
		ENDCG
	}
